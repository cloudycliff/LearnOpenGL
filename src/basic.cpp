...
DEFINE_APP(Basic, "Basic Example")

void Basic::init(const char *title) {
    base::init(title);

    ourShader = new Shader("shaders/vertex.glsl", "shaders/frag.glsl");
...
void Basic::display(bool auto_redraw) {
    // render
    // ------
...
void Basic::onKey(int key, int scancode, int action, int mods) {
